...
<head>
    <meta charset="utf-8">
    <title>Checkout - Hampers Teman Del</title>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Walker">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Last Name</label>
                            <input class="form-control" type="text" placeholder="Valentinus">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input class="form-control" type="text" placeholder="walkervalentinus@gmail.com">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No</label>
                            <input class="form-control" type="text" placeholder="+62812 4216 7189">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address </label>
                            <input class="form-control" type="text" placeholder="Jl. Sisingamangaraja">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Kelurahan</label>
                            <input class="form-control" type="text" placeholder="Matio">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>City</label>
                            <select class="custom-select">
                                <option selected>Laguboti</option>
                                <option>Porsea</option>
                                <option>Balige</option>
                                <option>Siantar Narumonda</option>
                                <option>Tambunan</option>
                            </select>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Kabupaten</label>
                            <input class="form-control" type="text" placeholder="Toba Samosir">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Kode Pos</label>
                            <input class="form-control" type="text" placeholder="22312">
                        </div>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <p>Christmas's Gift</p>
                            <p>Rp 100.000</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p>Congratulation Card</p>
                            <p>Rp 100.000</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p>Graduation's Gift</p>
                            <p>Rp 75.000</p>
                        </div>
                        <hr class="mt-0">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            <h6 class="font-weight-medium">Subtotal</h6>
                            <h6 class="font-weight-medium">Rp 275.000</h6>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold">Rp 290.000</h5>
                        </div>
                    </div>
                </div>
                <div class="card border-secondary mb-5">
