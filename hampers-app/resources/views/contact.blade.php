...
<head>
    <meta charset="utf-8">
    <title>Contact -  Hampers Teman Del</title>
        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><img src="img/transicon.png" alt="" style="width: 50px;">Hampers Teman Del</h1>   
                </a>
            </div>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <p class="text-justify">Menjadi pilihan utama bagi mahasiswa, teman, dan keluarga dalam memilih produk hampers untuk mewujudkan setiap momen spesial yang istimewa dan berkualitas dengan harga yang terjangkau.</p>

                            <!-- Additional content for Get In Touch -->
            <div class="social-icons mt-4">
                <h6 class="font-weight-semi-bold mb-3">Follow Us:</h6>
            ...
            <p class="mt-3">Stay connected with us on social media for the latest updates and promotions!</p>
        </div>
